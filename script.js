/* This JavaScript code manages the CRUD (Create, Read, Update, Delete) operations for the user profile system 
 The code utilizes localStorage to store the user data and dynamically updates the user interface based
 on user interactions. */


/* core functions 
   showinfo()  readinfo() editinfo ()  deleteinfo()  formsubmission  */
...
form.addEventListener('submit', (e)=> {
    ...
    if(!isEdit){
        ...
        getData[editId] = information
           ...
           /* New Entry: If isEdit is false, the information object is added to the getData array 
            (a collection of user profiles stored in localStorage).
             Edit Entry: If isEdit is true, it updates the existing user profile at the position identified
            by editId in the getData array.  */
    ...
    // Optionally remove the backdrop manually (in case it remains)
